...
const ROLE_PERMISSION_MATRIX: Record<RoleCode, readonly Permission[]> = {
  ...
  [ROLE_CODES.ADMIN]: [
    ...
    PERMISSIONS.EMPLOYEES_PERSONAL_VIEW,
    PERMISSIONS.EMPLOYEES_PERSONAL_UPDATE,
    PERMISSIONS.EMPLOYEES_EMPLOYMENT_VIEW,
    PERMISSIONS.EMPLOYEES_EMPLOYMENT_UPDATE,
    PERMISSIONS.EMPLOYEES_ADDRESS_VIEW,
    PERMISSIONS.EMPLOYEES_ADDRESS_UPDATE,
    PERMISSIONS.EMPLOYEES_INSURANCE_VIEW,
    PERMISSIONS.EMPLOYEES_INSURANCE_UPDATE,
    PERMISSIONS.EMPLOYEES_BANK_VIEW,
    PERMISSIONS.EMPLOYEES_BANK_UPDATE,
    PERMISSIONS.EMPLOYEES_FAMILY_VIEW,
    PERMISSIONS.EMPLOYEES_FAMILY_UPDATE,
    PERMISSIONS.EMPLOYEES_EDUCATION_VIEW,
    PERMISSIONS.EMPLOYEES_EDUCATION_UPDATE,
    PERMISSIONS.EMPLOYEES_DOCUMENT_VIEW,
    PERMISSIONS.EMPLOYEES_DOCUMENT_UPLOAD,
    PERMISSIONS.EMPLOYEES_DOCUMENT_DELETE,
    PERMISSIONS.EMPLOYEE_FIELDS_VIEW,
    PERMISSIONS.EMPLOYEE_FIELDS_CREATE,
    PERMISSIONS.EMPLOYEE_FIELDS_UPDATE,
    PERMISSIONS.EMPLOYEE_FIELDS_DELETE,
    PERMISSIONS.EMPLOYEE_CUSTOM_DATA_VIEW,
    PERMISSIONS.EMPLOYEE_CUSTOM_DATA_CREATE,
    PERMISSIONS.EMPLOYEE_CUSTOM_DATA_UPDATE,
    PERMISSIONS.EMPLOYEE_CUSTOM_DATA_DELETE,
    ...
    PERMISSIONS.WORK_LOCATIONS_VIEW,
    PERMISSIONS.WORK_LOCATIONS_MANAGE,
